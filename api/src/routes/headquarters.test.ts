...
describe('Headquarters API', () => {
    ...
    it('should create a new headquarters', async () => {
        const newHeadquarters = {
            headquartersId: 2,
            name: "CatTech Pacific HQ",
            description: "Pacific region feline tech hub",
            address: "999 Purr Boulevard, Catsville",
            contactPerson: "Oliver Paws",
            email: "oliver@octocat.com",
            phone: "555-0002"
        };
    ...
    it('should get a headquarters by ID', async () => {
        ...
        expect(response.status).toBe(200);
        expect(response.body).toMatchObject(seedHeadquarters[0]);
    });
    ...
    it('should update a headquarters by ID', async () => {
        ...
        expect(response.status).toBe(200);
        expect(response.body).toMatchObject(updatedHeadquarters);
    });
