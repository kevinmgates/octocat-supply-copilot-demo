...
describe('Supplier API', () => {
    ...
    it('should create a new supplier', async () => {
        const newSupplier = {
            supplierId: 4,
            name: "TabbyCo Industries",
            description: "Premium supplier of smart feline accessories",
            contactPerson: "Max Mittens",
            email: "max@tabbyco.com",
            phone: "555-0104"
        };
    ...
    it('should get a supplier by ID', async () => {
        ...
        expect(response.status).toBe(200);
        expect(response.body).toMatchObject(seedSuppliers[0]);
    });
