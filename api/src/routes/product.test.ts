...
describe('Product API', () => {
    ...
    it('should create a new product', async () => {
        const newProduct = {
            productId: 99,
            supplierId: 1,
            name: "CatNap Sleep Monitor",
            description: "Monitors your cat's sleep patterns and generates nightly reports.",
            price: 89.99,
            sku: "CAT-SLEEP-001",
            unit: "piece"
        };
    ...
    it('should get a product by ID', async () => {
        ...
        expect(response.status).toBe(200);
        expect(response.body).toMatchObject(seedProducts[0]);
    });
